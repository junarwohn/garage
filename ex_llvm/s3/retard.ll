...
define i32 @main() #4 {
  ...
  store float 0x40159999A0000000, float* %3, align 4
  %8 = load float, float* %2, align 4
  %9 = load float, float* %3, align 4
  %10 = fadd float %8, %9
  %11 = fpext float %10 to double
  %12 = fadd double %11, 3.500000e+00
  ...
  %22 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* @_ZSt4cout, float %21)
