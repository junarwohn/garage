...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spinBox_Main_pos = QtWidgets.QSpinBox(self.centralwidget)
        self.spinBox_Main_pos.setObjectName("spinBox_Main_pos")
        self.horizontalLayout_6.addWidget(self.spinBox_Main_pos)
        ...
        self.spinBox_Sub_pos = QtWidgets.QSpinBox(self.centralwidget)
        self.spinBox_Sub_pos.setObjectName("spinBox_Sub_pos")
        self.horizontalLayout_7.addWidget(self.spinBox_Sub_pos)
