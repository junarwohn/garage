...
pipeline = 'filesrc location=/home/j/paarthurnax/g2/vid.webm ! decodebin name=dec ! aspectratiocrop aspect-ratio=1/1 ! \
        videoconvert ! videoscale  ! video/x-raw,width=128,height=128 ! \
        tensor_converter ! tensor_transform mode=arithmetic option=typecast:float32,add:-127.5,div:127.5 ! \
        tensor_filter framework=pytorch model=/home/j/paarthurnax/g2/torchmodel.pt ! tensor_sink name=res_face \
        cairooverlay name=tensor_res ! ximagesink'
print(Gst)
