...
pipeline = 'filesrc location=/home/j/vanila_pa/paarthurnax/g2/vid.webm ! decodebin  !  aspectratiocrop aspect-ratio=1/1  ! videoconvert ! videoscale  ! video/x-raw,width=512,height=512  ! cairooverlay ! ximagesink'
print(Gst)
