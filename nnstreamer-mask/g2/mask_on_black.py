...
pipeline = 'filesrc location=/home/j/vanila_pa/paarthurnax/g2/vid.webm ! decodebin name=dec  !  aspectratiocrop aspect-ratio=1/1  ! videoconvert ! videoscale  ! video/x-raw,width=512,height=512  ! cairooverlay name=tensor_res ! ximagesink'
print(Gst)
